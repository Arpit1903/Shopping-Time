  ...
  return (
    <main className="order">
      ...
      <section className="order-success">
        ...
        <p>
          Your order has been received successfully at Shopping Time. We're
          thrilled that you've chosen us for your fashion needs. Your style
        ...
        <ul className="order-details">
          ...
          <li>
            Shipping Address: {orderFormValue.country}, {orderFormValue.city},{" "}
            {orderFormValue.postal}, {orderFormValue.address}
          </li>
        ...
        <p>
          Your items will be carefully prepared and dispatched for delivery. You
        ...
        customer support team at support@shoppingtime.com or +1 1234 344 2342.
        <br />
        <p> Happy Shopping!</p>
        <p>
          Warm regards, <br />
          The Shopping Time Team
        </p>
      </section>
      <section className="order-buttons">
        ...
        <button className="exit-order" onClick={handleLeavePage}>
          Continue shopping
        </button>
      </section>
      {showConfirmation && (
